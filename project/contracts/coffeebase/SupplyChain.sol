...
contract SupplyChain is Ownable, ConsumerRole, RetailerRole, DistributorRole, FarmerRole {
    ...
    // Call modifer to send any excess ether back to buye
    ...
    // Call modifier to check if upc has passed previous supply chain stage
    // Call modifier to verify caller of this function
    function shipItem(uint256 _upc) public onlyDistributor() sold(_upc)  verifyCaller(items[_upc].ownerID) {
        // Update the appropriate fields
    ...
    // Call modifier to check if upc has passed previous supply chain stage
    // Access Control List enforced by calling Smart Contract / DAp
